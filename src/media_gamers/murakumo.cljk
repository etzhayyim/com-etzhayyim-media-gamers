...
(defn collection
  [name]
  (str "com.etzhayyim.media-gamers." name))

(def cell-specs {
  :get {:legacy-cell "com-etzhayyim-apps-mediagamers-coverage-get"
     :phase :event
  ...
  :domain-knowledge {:legacy-cell "domain-knowledge"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :guide {:legacy-cell "com-etzhayyim-apps-media-gamers-guide"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "guide")]
     :required-gates common-gates
     :trigger "manifest cell guide"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :translation {:legacy-cell "com-etzhayyim-apps-media-gamers-translation"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "translation")]
     :required-gates common-gates
     :trigger "manifest cell translation"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :gametitle {:legacy-cell "com-etzhayyim-apps-media-gamers-gameTitle"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "gametitle")]
     :required-gates common-gates
     :trigger "manifest cell gametitle"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :modelevaluation {:legacy-cell "com-etzhayyim-apps-media-gamers-modelEvaluation"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "modelevaluation")]
     :required-gates common-gates
     :trigger "manifest cell modelevaluation"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
})
